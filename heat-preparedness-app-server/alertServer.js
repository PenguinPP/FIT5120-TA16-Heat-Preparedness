...
async function sendAlerts() {
  ...
  for (i = 0; i < userChoice_1day.length; i++) {
    var checkResult = await checkNotification(
      dbConnection,
      userChoice_1day[i],
      1
    );
  ...
  for (i = 0; i < user_list_1day.length; i++) {
    var notiBody =
      "There will be a heat wave tomorrow in " +
      user_list_1day[i]["suburb"] +
      ", please prepare for it and keep safe.";
  ...
  for (i = 0; i < user_list_3day.length; i++) {
    var notiBody =
      "There will be a heat wave in " +
      user_list_3day[i]["suburb"] +
      " on " +
      user_list_3day[i]["date"] +
      ", please prepare for it and keep safe.";
