...
export default function Alerts(suburbInfo) {
  ...
  const handleSubscribe = () =>{
        ...
        const subDetails = {
          suburbDetails: suburbData.filter((suburb) => suburb.suburb_id === suburbId)[0],
          oneDay: oneDay,
          threeDay: threeDay
        }
    ...
    return(
      ...
      <Typography paragraph variant="body1">When would you like to receive notifications? (you can select multiple)</Typography>
      <FormGroup row style={{ marginBottom: "2rem", }}>
      <FormControlLabel
        control={<Checkbox checked={oneDay} onChange={handleChangeOne} name="OneDayBefore" />}
        label="1 day before"
      />
      <FormControlLabel
        control={<Checkbox checked={threeDay} onChange={handleChangeThree} name="ThreeDaysBefore" />}
        label="3 days before"
      />
      </ FormGroup>
      <Button
      ...
      <DialogContent  className={page !== 2 && classes.hidePage}>
        <Typography paragraph variant="body1">
          Confirm your subscription details below. Once confirmed you will have to allow notifications when your browser asks.
        </Typography>
        <Typography  paragraph variant="body1">
           You have selected
        {currentSuburb !== undefined &&
        ...
        { oneDay ? <Typography  paragraph variant="body1">
          You will receive notifications 1 day before a heat wave.
         </Typography> : ""
        }
        {
          threeDay ? <Typography  paragraph variant="body1">
          You will receive notifications 3 days before a heat wave.
         </Typography> : ""
        }
