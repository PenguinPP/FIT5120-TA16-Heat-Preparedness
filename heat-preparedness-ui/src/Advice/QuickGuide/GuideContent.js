...
import { Typography, List, ListItem, ListItemIcon, CardMedia } from '@material-ui/core';
            ...
            <CardContent className={classes.cardContentStyle}>
                <Grid container alignItems="flex-start">
                        ...
                        <List>
                            {content[0]["content"].map((item, index) =>
                                <React.Fragment>
                                    <ListItem id={index}>
                                        <ListItemIcon>
                                            {content[0]["icons"][index] === "Do" ? <CheckIcon className={classes.tickStyle} /> : <ClearIcon className={classes.crossStyle} />}
                                        </ListItemIcon>
                    ...
                    <Grid item xs={12} md={3}>
                        <CardMedia image={noCoffeeAlcohol} className={classes.mediaCoffee} />
